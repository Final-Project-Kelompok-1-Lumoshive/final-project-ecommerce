  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        description:
          "South Asia’s premier online shopping makterplace with an active presense in Bangladesh. Exclusive offers a diverse assotment in categories ranging from consumer.",
        theme_color: "#ffffff",
        icons: [
          {
